// Soccer AI Service - Dual Personality System with Claude/Anthropic Integration
// This service simulates two AI agents chatting about soccer strategy using Claude
